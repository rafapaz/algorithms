...
public class Percolation {
	...
	public Percolation(int n) {
		assertTrue(n > 0, "Size of the grid must be greater than zero");
		this.gridSize = n;
	...
	public void open(int row, int col) {
		...
		assertTrue((row >= 1 && row <= this.gridSize), "Trying to open site out of the range");
		assertTrue((col >= 1 && col <= this.gridSize), "Trying to open site out of the range");
	...
	public Boolean isOpen(int row, int col) {
		int nrow, ncol;
		assertTrue((row >= 1 && row <= this.gridSize), "Trying to check if a site is open: grid values out of the range");
		assertTrue((col >= 1 && col <= this.gridSize), "Trying to check if a site is open: grid values out of the range");
	...
	public Boolean isFull(int row, int col) {
		int nrow, ncol;
		assertTrue((row >= 1 && row <= this.gridSize), "Trying to check if a site is full: grid values out of the range");
		assertTrue((col >= 1 && col <= this.gridSize), "Trying to check if a site is full: grid values out of the range");
